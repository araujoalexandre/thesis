...
\begin{figure*}[htb]
  ...
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/part2/ch9-singular_value_bound/contour_poly_200_1_1_5.pdf}\\kernel $1\times5\times5$
  \end{minipage}
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/part2/ch9-singular_value_bound/contour_poly_200_1_9_5.pdf}\\kernel $9\times5\times5$
  \end{minipage}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.50]{figures/part2/ch9-singular_value_bound/convergence_bound.pdf}
...
% \begin{figure*}[htb]
%     \centering
%     \includegraphics[scale=0.55]{figures/part2/ch9-singular_value_bound/singular_values.pdf}
