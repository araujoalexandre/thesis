...
However, the expressivity of the network with orthogonal weight matrices is clearly \tototext{jamal why ?} limited, thus the natural accuracy obtained by these networks is far from being state-of-the-art. 
