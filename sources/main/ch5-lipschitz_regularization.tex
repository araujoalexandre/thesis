...
We will need to generalize the doubly-block Toeplitz operator presented in~\Cref{section:ch5-bound_on_the_singular_value_of_doubly-block_toeplitz_matrices}.
...
\begin{figure}[ht]
  ...
  \caption{Representation of the function $\Gamma(n)$ defined in \Cref{subsection:ch2-analysis_of_the_tightness_of_the_bound} for different kernel size.}
