...
\begin{figure*}[htb]
  ...
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/main/ch5-lipschitz_regularization/contour_poly_200_1_1_5.pdf}\\kernel $1\times5\times5$
  \end{minipage}
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/main/ch5-lipschitz_regularization/contour_poly_200_1_9_5.pdf}\\kernel $9\times5\times5$
  \end{minipage}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.50]{figures/main/ch5-lipschitz_regularization/convergence_bound.pdf}
...
\begin{figure}[ht]
   ...
   \begin{subfigure}[b]{0.49\textwidth}
       \centering
       \includegraphics[width=\textwidth]{figures/main/ch5-lipschitz_regularization/jacobian_distribution_v1.pdf}\\(a)
   \end{subfigure}
   \hfill
   \begin{subfigure}[b]{0.49\textwidth}
       \centering
       \includegraphics[width=\textwidth]{figures/main/ch5-lipschitz_regularization/jacobian_distribution_v2.pdf}\\(b)
   \end{subfigure}
...
%   \begin{minipage}{.24\linewidth}
%     \centering
%     \includegraphics[scale=0.16]{figures/main/ch5-lipschitz_regularization/jacobian_distribution_v1.pdf}\\{(a)}
%   \end{minipage}
%   \hfill
%   \begin{minipage}{.24\linewidth}
%     \centering
%     \includegraphics[scale=0.16]{figures/main/ch5-lipschitz_regularization/jacobian_distribution_v2.pdf}\\{(b)}
%   \end{minipage}
%   \hfill
%   \begin{minipage}{.24\linewidth}
%     \centering
%     \includegraphics[scale=0.16]{figures/main/ch5-lipschitz_regularization/attacks_iter_pgd.pdf}\\{(c)}
%   \end{minipage}
%   \hfill
%   \begin{minipage}{.24\linewidth}
%     \centering
%     \includegraphics[scale=0.16]{figures/main/ch5-lipschitz_regularization/attacks_iter_cw.pdf}\\{(d)}
%   \end{minipage}
...
% \begin{itemize}
%     \item \makebox[3.2cm]{\cite{sedghi2018singular}\hfill} \url{https://github.com/brain-research/conv-sv}
...
% \end{itemize}
% We translated the code of \cite{sedghi2018singular} from TensorFlow to PyTorch in order to use the PyTorch CUDA Profiler.
%
...
% \begin{figure*}[htb]
%     \centering
%     \includegraphics[scale=0.55]{figures/main/ch5-lipschitz_regularization/singular_values.pdf}
