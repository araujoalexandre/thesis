...
\begin{figure}
   ...
   \begin{subfigure}[b]{0.49\textwidth}
       \centering
       \input{figures/main/ch4-diagonal_circulant/cifar10_factor.tex}
       \caption{
   ...
   \begin{subfigure}[b]{0.49\textwidth}
       \centering
       \input{figures/main/ch4-diagonal_circulant/cifar10_leaky_relu.tex}
       \caption{
...
\begin{figure}
   \centering
   \input{figures/main/ch4-diagonal_circulant/scatterplot.tex}
