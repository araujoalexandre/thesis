...
\Cref{figure:ch1-alexnet_network} shows the AlexNet architecture which consists of five convolution layers with two fully connected layers at the end.
...
\Cref{figure:ch1-adversarial_image_example} gives an example of an adversarial attack on an image.
...
% They use convolution layers which are specific to image processing and use very few parameters.
...
\Cref{chapter:ch3-related_work} is dedicated to discussing the state-of-the-art approaches related to our contributions.
...
\Cref{chapter:ch6-conclusion} proposes a discussion and some perspectives on our contributions.
