...
\label{section:ch3-introduction}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{theorem}[Reformulation from \citet{Huhtanen2015}] \label{theorem:ch3-huhtanen}
...
\begin{theorem}[Rank-based circulant decomposition] \label{theorem:ch3-rank-decomposition}
...
\begin{theorem}[Rank-based expressive power of DCNNs] \label{theorem:ch3-low_rank_nn}
...
\begin{proof}[\proofrefth{theorem:ch3-low_rank_nn}]
...
\label{section:ch3-how_to_train_deep_diagonal_circulant_neural_networks}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
   ...
   \begin{subfigure}[b]{0.49\textwidth}
	...
	Deep DCNNs with fewer ReLUs are easier to train.}
       \label{figure:ch3-cifar10_factor}
   \end{subfigure}
   \hfill
   \begin{subfigure}[b]{0.49\textwidth}
       \centering
       ...
       \label{figure:ch3-cifar10_leaky_relu}
   \end{subfigure}
...
\label{subsection:ch3-comparison_with_other_structured_approches}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
   ...
   \begin{subfigure}[b]{0.49\textwidth}
       ...
       \label{figure:ch3-acdc_regression}
   \end{subfigure}
   \hfill
   \begin{subfigure}[b]{0.49\textwidth}
       \centering
...
% \label{subsection:ch3-large_scale_video_classification}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% The Deep Bag-of-Frames architecture can be decomposed into three blocks of layers, as illustrated in Figure~\ref{figure:ch3-archi_youtube}.
...
%   \label{figure:ch3-archi_youtube}
% \end{figure}
%
