...
\begin{figure*}[htb]
  ...
  \begin{minipage}{.24\linewidth}
    \centering
    \includegraphics[scale=0.23]{figures/chapter5/contour_poly_200_1_1_3.pdf}\\kernel $1\times3\times3$
  \end{minipage}
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/chapter5/contour_poly_200_1_9_3.pdf}\\kernel $9\times3\times3$
  \end{minipage}
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/chapter5/contour_poly_200_1_1_5.pdf}\\kernel $1\times5\times5$
  \end{minipage}
  \begin{minipage}{.24\linewidth}
      \centering
      \includegraphics[scale=0.23]{figures/chapter5/contour_poly_200_1_9_5.pdf}\\kernel $9\times5\times5$
  \end{minipage}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.50]{figures/chapter5/convergence_bound.pdf}
...
% \begin{figure*}[htb]
%     \centering
%     \includegraphics[scale=0.55]{figures/chapter5/singular_values.pdf}
