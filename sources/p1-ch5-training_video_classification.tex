...
\begin{figure}[htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/fig_baseline}
...
\begin{figure}[htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/fig_ensemble_with_fc}
...
\begin{figure}[htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/graph_robust_dbof}
...
\begin{figure}[htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/graph_layers}
...
\begin{figure}[htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/graph_dc_cd}
...
\begin{figure}[!htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/graph_fc_circulant_embeddings}
...
\begin{figure}[htb]
  \centering
  \input{figures/part1/ch5-training_video_classification/graph_models}
