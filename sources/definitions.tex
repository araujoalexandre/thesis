...
% \usepackage{minitoc}        % produce a table of contents for each chapter
...
% Definition d'une matrice: parenthese ou crochet
\newcommand{\leftmat}{\left(} 
\newcommand{\rightmat}{\right)}

% definition de l'index a_h et B_h
\newcommand{\seqidx}{h}
\newcommand{\seqsetN}{N}
\newcommand{\seqsetM}{M}
...
% matrix brackets
\newcommand{\BEGINMAT}{\begin{pmatrix}}
...
\newcommand{\ACDC}{\textbf{ACDC}\xspace}
\newcommand{\AFDF}{\textbf{AFCF}\xspace}
