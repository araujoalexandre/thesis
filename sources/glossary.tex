...
\newglossaryentry{integer set}{%
  name        = {$[n]$},
  description = {The set $\left\{ x \in \Nbb \mid 1 \leq x \leq b \right\}$},
}
...
\newglossaryentry{set P}{%
  name        = {$\mathcal{P}$},
  description = {The set $\left\{ -n+1, \dots, n-1 \right\}$},
}

\newglossaryentry{set P 0}{%
  name        = {$\mathcal{P}_0$},
  description = {The set $\left\{ 0, \dots, n-1 \right\}$},
}
