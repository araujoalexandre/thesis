...
\begin{figure}[htb]
  \centering
  \input{figures/appendix2/fig_baseline}
...
\begin{figure}[htb]
  \centering
  \input{figures/appendix2/fig_ensemble_with_fc}
...
\begin{figure}[htb]
  \centering
  \input{figures/appendix2/graph_robust_dbof}
...
\begin{figure}[htb]
  \centering
  \input{figures/appendix2/graph_layers}
...
\begin{figure}[htb]
  \centering
  \input{figures/appendix2/graph_dc_cd}
...
\begin{figure}[!htb]
  \centering
  \input{figures/appendix2/graph_fc_circulant_embeddings}
...
\begin{figure}[htb]
  \centering
  \input{figures/appendix2/graph_models}
