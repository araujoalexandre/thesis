...
\begin{axis}[
  ...
  \addplot[color=red] table [y=gap, x=epoch]{figures/part1/ch5-training_video_classification/dc_cd/dc.dat};
  \addplot[color=blue] table [y=gap, x=epoch]{figures/part1/ch5-training_video_classification/dc_cd/cd.dat};
\legend{
