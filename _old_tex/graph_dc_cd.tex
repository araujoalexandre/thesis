...
\begin{axis}[
  ...
  \addplot[color=red] table [y=gap, x=epoch]{figures/scripts/ap2-graph_comparison_learned_diagonal_data/learned_diag.dat};
  \addplot[color=blue] table [y=gap, x=epoch]{figures/scripts/ap2-graph_comparison_learned_diagonal_data/fixed_diag.dat};
\legend{
