...
\begin{document}
  ...
  \input{sources/ch2-background}
  \input{sources/ch3-related_work}
  \input{sources/ch4-diagonal_circulant}
  \input{sources/ch5-lipschitz_bound}
  \input{sources/ch6-conclusion}

  \renewcommand\appendixpagename{\usekomafont{disposition}Appendices}
  \begin{appendices}
    \renewcommand\chaptername{Appendix}
    \input{sources/ap1-technical_proofs.tex}
    \input{sources/ap2-training_video_classification.tex}
    \input{sources/ap3-randomized_inference}
    \input{sources/ap4-advocating_for_multiple_defense_strategies}
    \input{sources/ap5-datasets.tex}
    \input{sources/ap6-publications.tex}
  \end{appendices} 
